...
<b>Figure 9</b>: This is a really interesting one; there are many Waldo lookalikes,<br> but only one real (as described in the text on the image).<br> The agent obviously did not find him because he is not<br> trained to do that in this manner.
</p>
